...
public class HttpRequest {
    ...
    public static void main(String[] args) {
        ...
        param.put("userName", "gongsi02");
        param.put("userPwd", "888888");
        param.put("type", "UNIT");
        param.put("appkey", "1");
        param.put("sign", "1c1aee126642393f93c2f3ab5699ef48");
        
        String sr=HttpRequest.sendPost("http://192.168.1.129:5555/app/v1/user/login", param);
        System.out.println(sr);
    }
    
    private static String convertMap(Map<String,Object> param){
    	...
    	String paramStr ="";
    	if(sbf.length()>0)
    	paramStr = sbf.substring(0, sbf.lastIndexOf("&"));
    	return paramStr;
    }
}